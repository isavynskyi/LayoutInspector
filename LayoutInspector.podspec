#
# Be sure to run `pod lib lint LayoutInspector.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of LayoutInspector.'
...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'Igor' => 'i.savinskiy@mobidev.biz' }
  ...
  # s.resource_bundles = {
  #   'LayoutInspector' => ['LayoutInspector/Assets/*.png']
  # }
